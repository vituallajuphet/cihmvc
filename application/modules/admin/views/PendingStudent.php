  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Pending Students</h1>
          </div><!-- /.col -->
                      ...
                      foreach ($students as $student) {
                        ?>
                          <tr role="row">
                            ...
                            <td>
                            <a href="<?= base_url("admin/approveduser/". $student["user_id"]);?>"><i class="fa fa-check"></i>Approved</a>
                            <a style="color:#a42828;display:inline-block;margin-left:10px;" href="<?= base_url("admin/rejectuser/". $student["user_id"]);?>"><i class="fa fa-trash"></i>Reject</a>
