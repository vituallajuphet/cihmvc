      ...
      <div class="container-fluid">
        <div class="row">
          <!-- start -->
              ...
              <form role="form" method="post" action="<?=base_url("admin/update_student")?>">
                <div class="card-body">
                  <div class="row">
                        <input type="hidden" name="user_id" value="<?= $students[0]["user_id"];?>">
                      <div class="col-md-6">
                             <div class="form-group">
                            <label for="exampleInputEmail1">Student Name:</label>
                           <input type="text" value="<?= $students[0]["fullname"];?>" name="fullname"  class="form-control">
                            </div>
                      </div>
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                          ...
                          <input type="email" value="<?= $students[0]["email"];?>" name="email"  class="form-control">
                            </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="number" name="age" value="<?= $students[0]["age"];?>"  class="form-control">
                          </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="exampleInputFile" name="student">Username:</label>
                          <input type="text" name="username" value="<?= $students[0]["username"];?>"  class="form-control">
                          </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="exampleInputFile" name="password">Password:</label>
                          <input type="text" value="<?= $students[0]["password"];?>" name="password"  class="form-control">
                          </div>
                      </div>
