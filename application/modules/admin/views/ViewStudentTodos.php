  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Todo list (<span style="color:#007bff;"><?= $students[0]["fullname"]; ?></span>)</h1>
    <br>
            <a class="btn btn-danger" href="<?= base_url("admin/students");?>">Back</a>
          </div><!-- /.col -->
                      ...
                      foreach ($todos as $todo) {
                        ?>
                          <tr role="row">
                            ...
                            <td class="sorting_1"><?= ($todo["completed"] == "no" ? "Pending" : "Completed"); ?></td>
                            <td>
