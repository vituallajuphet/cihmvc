      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-3 pull-right">
             <button class="btn btn-primary btnNewInstruction" ><i class="fa fa-edit"></i> Add Instruction</button>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
      ...
      <div class="container-fluid">
        ...
        <div class="col-sm-12">
            ...
            <div class="card card-default">
              ...
              <form role="form" method="post" action="<?=base_url("admin/update_todo");?>">
                <div class="card-body">
                  <div class="row">
                    <input type="hidden" name="todo_id" value="<?=  $todos[0]["todo_id"]; ?>">
                      <div class="col-md-12">
                            ...
                            <textarea name="content" required class="form-control"><?= $todos[0]["content"]; ?></textarea>
                            </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
        ...
        <div class="col-sm-12">
            ...
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">Additional Instructions:</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" id="<?= $todos[0]["todo_id"]; ?>" class="btn btn-primary btnSaveAddInfo">Save changes</button>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
