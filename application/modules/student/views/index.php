      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item active">
            <a href="<?=base_url("students/dashboard");?>" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">My Todo List</h1>
          </div><!-- /.col -->
                      ...
                      foreach ($todos as $todo) {
                        ?>
                          <tr role="row">
                            ...
                            <td>
                            <a href="<?=base_url("students/edittodos")."/". $todo["todo_id"];?>"><i class="fa fa-edit"></i> View</a>
