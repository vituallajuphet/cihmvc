  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Todos</h1>
          </div><!-- /.col -->
          <div class="col-md-3">
          ...
          <div class="col-md-3">
           ...
           <input type="date"  class="form-control pull-right searchDate" >
    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <!-- start -->
        <div class="col-sm-12"><table id="example2" class="table table-striped table-bordered" role="grid" aria-describedby="example2_info">
                <thead>
                <tr role="row">
                      ...
                      foreach ($todos as $todo) {
                        ?>
                          <tr role="row">
                            ...
                            <td>
                                <?php  if($user["user_id"] !=  $todo["user_id"]) {?>
                                    <a href="<?=base_url("students/viewtodo")."/". $todo["todo_id"];?>"><i class="fa fa-eye"></i> View</a>
                                <?php }else {?>
                                    <a href="<?=base_url("students/edittodos")."/". $todo["todo_id"];?>"><i class="fa fa-eye"></i> View</a>
                                <?php }?>
